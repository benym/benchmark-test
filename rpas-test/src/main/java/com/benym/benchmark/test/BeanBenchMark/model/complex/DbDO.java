...
public class DbDO implements Serializable {
    ...
    private static final long serialVersionUID = 6345474466337896832L;


    private MockOne mockOne;
    private MockTwo mockTwo;
    private String name;
    private Integer age;
    private Date time;
    ...
    public MockOne getMockModelOne() {
        return mockOne;
    }

    public void setMockModelOne(MockOne mockOne) {
        this.mockOne = mockOne;
    }

    public MockTwo getMockModelTwo() {
        return mockTwo;
    }

    public void setMockModelTwo(MockTwo mockTwo) {
